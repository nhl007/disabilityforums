export const selectOptions = [
  {
    ...
    options: [
      ...
      {
        value: "Accessing the Community",
        label: "Accessing the Community",
      },
      {
        value: "Nurse",
        label: "Nurse",
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: "Other (Sand, Animal, Play)",
        label: "Other (Sand, Animal, Play)",
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        value: "Specialist Support Coordinator",
        label: "Specialist Support Coordinator",
      },
      {
        value: "Recovery Coach (PRS)",
        label: "Recovery Coach (PRS)",
      },
    ],
  },
  {
    ...
    options: [
      {
        value: "Support in Employment",
        label: "Support in Employment",
      },
      {
        value: "Life Skills",
        label: "Life Skills",
...

  {
    ...
    options: [
      {
        value: "Disability Aids",
        label: "Disability Aids",
      },
    ],
  },
];
...
export const agesSupportedOptions = [
  {
    label: "Early Childhood (0-7 years)",
    value: "Early Childhood (0-7 years)",
  },
