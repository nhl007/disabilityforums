  ...
  return (
    <div className="flex flex-col rounded-2xl p-6 bg-bg-main">
      ...
      <div className="flex mt-4">
        ...
        <select className=" py-3 text-base px-4 border w-[270px] h-[71px] focus:outline-none">
        ...
        <select className="rounded-r-[6px] py-3 text-base px-4 border w-[270px] h-[71px] focus:outline-none">
        ...
        <button className=" ml-2 bg-btn-orange px-4 rounded-md">Search</button>
      </div>
